<template>
  <div class="template5-resume resume-content">
    ...
    <div class="content">
      <!-- 核心技能 -->
      <section v-if="value.skillList?.length" class="section skills-section">
        <h2 class="section-title" :style="{ color: theme.color }">
          {{ t('核心技能') }}
        </h2>
        <div class="skills-container">
          <div v-for="(skill, idx) in value.skillList" :key="idx" class="skill-tag" :style="{ background: theme.tagColor }">
            {{ skill.skill_name }}
          </div>
        </div>
      </section>
      ...
      <section class="section">
        ...
        <div class="section-content">
          <!-- 教育背景 -->
          <div v-if="value.educationList?.length" class="ability-item">
            <h3 class="ability-title">{{ t('教育背景') }}</h3>
          ...
          <!-- 工作经历 -->
          <div v-if="value.workExpList?.length" class="ability-item">
            <h3 class="ability-title">{{ t('工作经历') }}</h3>
            <div class="ability-details">
              <div
          ...
          <!-- 项目经历 -->
          <div v-if="value.projectList?.length" class="ability-item">
            <h3 class="ability-title">{{ t('项目经历') }}</h3>
            <div class="ability-details">
              <div
